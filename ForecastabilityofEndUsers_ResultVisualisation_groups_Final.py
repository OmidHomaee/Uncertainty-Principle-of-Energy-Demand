...
data_Vis_groups2 = pd.read_csv("C:/Omid/end User resolution/MAPE_Results_DF_MLMAE_200_FF.csv")


#data_Vis_groups1 = pd.read_csv("C:/Omid/MAPE_Results_DF_LSTM_GroupReso.csv")


data_Vis_groups =data_Vis_groups2  # pd.concat([data_Vis_groups1, data_Vis_groups2])
...
plt.savefig('MAPE_EndUser_res_elmaFinal.png',  format="png", dpi=600, bbox_inches='tight')
...
plt.savefig('MAPE_enduser_elmaFinal.png',  format="png", dpi=600, bbox_inches='tight')
